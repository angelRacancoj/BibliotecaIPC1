...
public class ListadoLibrosFrame extends javax.swing.JInternalFrame {
    ...
    ManejadorLibros manejador;
    List<Libro> listalibros;
    ObservableList<Libro> listaLibrosObser;

    public ListadoLibrosFrame(ManejadorLibros manejador) {
    ...
    private void buscarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarButtonActionPerformed
        actualizarBusquedaObservable(manejador.buscarLibro(filtrosComboBox.getSelectedIndex(),codigoLibroFormattedTextField.getText()));
