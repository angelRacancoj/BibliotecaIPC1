...
public class listadoEstudiantesFrame extends javax.swing.JInternalFrame {
    ...
    ManejadorEstudiantes manejador;
     ...
     */
    public listadoEstudiantesFrame(ManejadorEstudiantes manejador) {
    ...
    private void buscarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarButtonActionPerformed
        if (carnetFormattedTextField.getText().replace(" ", "").isEmpty()) {
            actualizarBusquedaObservable(manejador.consultaEstudiantes());
        } else {
            actualizarBusquedaObservable(manejador.listadoEstPorCarnet(carnetFormattedTextField.getText()));
        }
        limpiar();
